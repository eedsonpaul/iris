...
<ul>
  <li> <a href="#"> PERSONAL DATA </a>
	...
	<li>
	  <ul>
  		<li><a href="student_confirm subject here.php">confirm subject here </a></li>
  		<li><a href="student_edit enrollment data here.php">edit enrollment data here</a></li>
	  </ul>
	</li>
  </ul>
...
<div id="contentcolumn1">
  <ul>
    <li><a href="student_edit enrollment data here.php">edit enrollment data here</a> content here </li>
  </ul>
</div>
