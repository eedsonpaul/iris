<?php 
  ...
  require_once '../admin_http.php';
	if($_SESSION['access_level_id'] != 4 and $_SESSION['access_level_id'] != 3) 
	  redirect('../error.php');
?>
...
<head>
  ...
  <title>Admin &raquo; Accounting | UP Cebu IRIS </title>
  <?php } ?>
  <title>Accounting | UP Cebu IRIS</title>
...
<script language="JavaScript">
	...
	function init(){
		...
		oStringMask = new Mask("##############");
		oStringMask.attach(document.accountingform.loaned_amount);
...
<body onLoad="init();">
  <div id="banner">
    <?php if (!isset($_SESSION['employee_id'])) { ?>
      <a href="accounting.php"><img src="../img/banner.jpg" width="950" height="163" border="0"></a>
    <?php } else { ?>
      <a href="accounting.php?action=Logs"><img src="../img/banner.jpg" width="950" height="163" border="0"></a>
    <?php } ?>
  </div>
  </div>
