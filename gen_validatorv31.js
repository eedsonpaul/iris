...
function TestEqual(objValue,strEqual,strError)
{
var ret = true;
	  if(isNaN(objValue.value)) 
	  { 
	  ...
	  if(eval(objValue.value) <=  eval(strEqual) || eval(objValue.value) == 0) 
	  { 
	    if(!strError || strError.length ==0) 
	    { 
	      strError = objValue.name + " : Phone Number Format. "+ strEqual; 
	    }//if               
	    sfm_show_error_msg(strError,objValue); 
	    ret = false;                 
	   }//if   
...
{
  var frm = document.forms["createform"];
