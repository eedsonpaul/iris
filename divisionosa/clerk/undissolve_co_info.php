...
?>
<h1 align="center">Undissolve Section</h1>
...
<p>Are you sure you want to undissolve the selected section?</p>
	<input type='submit' name='undissolve' value='Yes'/>
	<input type='submit' name='undissolve' value='No'/>
</form>
