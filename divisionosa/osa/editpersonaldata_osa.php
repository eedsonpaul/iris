<?php require_once 'header.php' ?>
    <p align="left" class="style4">osa's personal data content here </p>
  ...
  <table cellpadding="1" cellspacing="2">
    ...
    <tr>
    	...
    	<td>Borbajo Street</td>
    </tr>
    <tr>
    	<td>address barangay subdivision</td>
    	<td>bacayan</td>
    </tr>
    <tr>
    	<td>address city municipality</td>
    	<td>Cebu City</td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
    	<td>Employee Designation</td><td>MASTER PROFESSOR 5000</td>
    </tr>
    <tr>
    	<td>Division</td>
