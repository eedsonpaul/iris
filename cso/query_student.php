...
$degree_program = getDegreeProgram($student_number);
	$result=mysql_query("SELECT major from degree_program where degree_program=$degree_program");	 
	while($row = mysql_fetch_array($result)){		
		$major = $row['major'];
	 }
		return $major;
...
$degree_program = getDegreeProgram($student_number);
	$result=mysql_query("SELECT minor from degree_program where degree_program=$degree_program");	 
	while($row = mysql_fetch_array($result)){		
		$major = $row['major'];
	 }
		return $major;
