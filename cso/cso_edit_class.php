  ...
  <form action="cso_process_edit_maximum_slots.php?id=<?php echo $subject_code;?>&sec=<?php echo $section_lab;?>" method="post">
    <table width="494" border="0" align="center" class="tab">
      <tr>
        ...
        <td width="12">&nbsp;</td>
        <td width="287"><?php echo strtoupper($subject_code);?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><input type="text" name="class_type" id="class_type" value="<?php echo strtoupper($class);?>" disabled></td>
      </tr>
      <tr>
        <td><div align="right">Degree Program:</div></td>
        <td>&nbsp;</td>
        <td><?php
          echo "<label>";
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><input type="text" name="orig_max_units" id="orig_max_units" value="<?php echo $total_slots;?>" disabled></td>
      </tr>
      <tr>
