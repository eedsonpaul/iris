...
<html>
<head>
<title>CSO General Registration</title>
...
<div id="contentcolumn1">
  ...
  <p class="headfont">&nbsp;</p>
    <table width="494" border="0" align="center">
      <tr>
        <td><div align="center"><strong>ENROLL STUDENT</strong></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <form action="cso_enroll_student.php" method="get">
      <tr>
        <td width="208"><div align="right"><strong>Enter Student Number:</strong></div></td>
        <td width="11">&nbsp;</td>
      ...
      <tr>
        <td><div align="center"><strong>STAMP REGISTERED</strong></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><div align="right"><strong>Enter Student Number</strong></div></td>
        <td>&nbsp;</td>
