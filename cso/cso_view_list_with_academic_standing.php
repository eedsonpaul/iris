...
//Version 2: Date: October 5, 2010
//Version 1: Date: September 16, 2010
...
<div class="main">
	...
	<div id="right_side">
		...
		<p class="headfont">&nbsp;</p>
		<p class="head"><strong>ACADEMIC STANDING OF STUDENTS</strong></p>
		<p class=normaltext><center>CURRENT SEMESTER : CURRENT AY</center></p>
		<p>&nbsp;</p>
		
		<center><table width=400><tr>
			<th align=center valign=center width=200>NAME</th>
			<th align=center valign=center width=150>ACADEMIC STANDING</th>
		</tr>
		
		<?php
			//scenario: current SEMESTER = FIRST SEMESTER, CURRENT ACADEMIC YEAR = 20102011
			$student_array= mysql_query("SELECT * FROM student ORDER BY last_name ASC");
			while ($students = mysql_fetch_array($student_array)) {
				extract($students);
				
				echo "<tr><td>".$last_name. ", ".$first_name. " " .$middle_name. "</td>";
				echo "<td>". $academic_standing. "</td>";
			}
		?>
