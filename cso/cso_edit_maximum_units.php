...
<div id="right_side">
  ...
  <form action="cso_process_edit_maximum_units.php?id=<?php echo $student_ID;?>" method="post">
    <table width="494" border="0" align="center" class="tab">
      ...
      <tr>
        <td><div align="right">Original Maximum Units:</div></td>
        <td>*</td>
        <td><input type="text" name="orig_max_units" id="orig_max_units" value="<?php echo $max_units_allowed;?>" readonly></td>
      </tr>
      <tr>
        <td><div align="right">New Maximum Units:</div></td>
        <td>*</td>
        <td><input type="text" name="new_max_units" id="new_max_units" value=""></td>
      </tr>
      </table>
    <p>
      <center><input type="submit" name="edit_maximum_units" id="edit_maximum_units" value="UPDATE">
      </center>
    </p>
  </form>
  <p>&nbsp;</p>
