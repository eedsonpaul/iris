...
<div id="contentcolumn1">
    <p class="headfont">&nbsp;</p>
  <p class="head"><strong>EDIT EMPLOYEE</strong></p>
  ...
  <form action="" method="post">
	...
	$act = $_GET['action'];
	if ($act=="LOGIN") {
		$path = "cso_add_employee_login_info.php?action=EDIT";
	} else if ($act=="PERSONAL") {
		$path = "cso_add_employee_record.php?action=EDIT";
	}
	...
	while ($row = mysql_fetch_array($result)){
        ...
        <td width='164'><div align='center'><strong><a href="<?php echo $path;?>&id=<?php echo $emp_id;?>">EDIT</a></strong></div></td>
      	</tr>
	  <?php }
	  } ?>
    </table>
