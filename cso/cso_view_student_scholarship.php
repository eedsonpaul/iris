...
<div class="main">
	...
	if($count==0){
		...
		<tr>
			<td width="181"><div align="right"><b>Scholarship:</b></div></td>
			<td width="12">&nbsp;</td>
			<td width="287">
				<?php 
					$s=mysql_fetch_array(mysql_query("SELECT * FROM scholarship WHERE scholarship_id='$scholarship_id' "));
					echo $s['scholarship_name']; 
				?>
			</td>
		</tr>
